"""
Benchmark khả năng xử lý của CoreML.
"""
...
def run_benchmark():
    ...
    log_path = "output/log_coreml.txt"
    ...
    print(f"\n🚀 BẮT ĐẦU BENCHMARK YOLOv8 TRÊN APPLE SILICON (ENGINE: {ep.upper()})")
    ...
    print("\n" + "="*60)
    print(f"🏁 Benchmark CoreML kết thúc. Log đã được lưu tại {log_path}")
