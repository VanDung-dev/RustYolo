"""
Benchmark khả năng xử lý của CPU.
"""
...
def run_benchmark():
    ...
    print(f"\n💻 BẮT ĐẦU BENCHMARK YOLOv8 TRÊN CPU FALLBACK (ENGINE: {ep.upper()})")
    ...
    for model_name in models:
        ...
        try:
            ...
            print("Đang đo lường hiệu suất (CPU)...")
    ...
    print("\n" + "="*60)
    print(f"🏁 Benchmark CPU kết thúc. Log đã được lưu tại {log_path}")
